<template>
  <div class="inner">
    <div class="main">
      <div class="head">
        <p class="wisdom">文档中心</p>
        <div class="r_wisdom">
          <img :src="address" alt="">
          <router-link :to="{name:'index'}">首页</router-link>
          >
          <router-link :to="{name:'index'}">文档中心</router-link>
        </div>
      </div>
      <div class="content">
        <div class="l_cont">
    ...
    mounted() {
      ...
      layui.use('laypage', function(){
        ...
        laypage.render({
          ...
          ,count: res.document.length
          ,limit:12,
          theme:"#4e89e3"
          ,jump: function(obj){
            const pageDate = res.document.concat().splice(obj.curr*obj.limit - obj.limit, obj.limit);
